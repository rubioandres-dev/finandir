...
const ES_AR = {
  ...
  'nav.ajustesDetalle': 'Divisas, región, idioma, módulos y datos',
  'nav.configuracion': 'Configuración',
  'nav.perfil': 'Perfil',
  'nav.perfilDetalle': 'Tu nombre, tu email y tu contraseña',
...
const EN: Parcial = {
  ...
  'nav.ajustesDetalle': 'Currencies, region, language, modules and data',
  'nav.configuracion': 'Settings',
  'nav.perfil': 'Profile',
  'nav.perfilDetalle': 'Your name, email and password',
